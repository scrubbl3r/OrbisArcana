...
import { GRAPHITE_CONFIG } from "./graphite-config.js?v=20260426a";

function createGraphiteSurfaceTexture(config = GRAPHITE_CONFIG) {
...
export function createGraphiteMaterial(config = GRAPHITE_CONFIG) {
...
export const createGraphitePlinthMaterial = createGraphiteMaterial;

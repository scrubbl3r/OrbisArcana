...
export function createShockwaveAuthoringAdapter({
  ...
  function defaultSettings() {
    ...
    return {
      shockStartRatio: fixedNumber(clampNumber(shockwavePresetDefault.startRatio, 0.01, 10, 0.43), 2, 0.43),
      shockEndRatio: fixedNumber(clampNumber(shockwavePresetDefault.endRatio, 0.01, 20, 1.69), 2, 1.69),
      ...
      shockStrokeRatio: fixedNumber(clampNumber(shockwavePresetDefault.strokeRatio, 0.005, 1, 0.04), 3, 0.04),

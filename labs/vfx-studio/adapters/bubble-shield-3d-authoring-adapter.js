...
export function createBubbleShield3dAuthoringAdapter({
  ...
  function defaultSettings() {
    ...
    return {
      ...
      energyG: energy.g,
      energyB: energy.b,
      mutationSpeed: fixedNumber(clampNumber(bubbleShield3dPresetDefault.mutationSpeed, 0, Infinity, 2), 2, 2),
      mutationAmount: fixedNumber(clampNumber(bubbleShield3dPresetDefault.mutationAmount, 0, Infinity, 1.5), 2, 1.5),

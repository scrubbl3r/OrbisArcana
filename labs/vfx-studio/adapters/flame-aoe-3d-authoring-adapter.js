...
export function createFlameAoe3dAuthoringAdapter({ flameAoe3dBehaviorDefault = {} } = {}) {
  ...
  function capture(els) {
    return Object.freeze({
      ...
      wakeSdfRenderMode: Math.round(clampNumber(els && els.flameAoe3dWakeSdfRenderMode && els.flameAoe3dWakeSdfRenderMode.value, 0, 5, FLAME_AOE_3D_DEFAULTS.wakeSdfRenderMode)),

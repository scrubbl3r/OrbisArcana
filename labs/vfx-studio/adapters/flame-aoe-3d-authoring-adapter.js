const FLAME_AOE_3D_FIELDS = Object.freeze([
  ...
  ["flameAoe3dWakeSdfPerlinDensityBottom", "wakeSdfPerlinDensityBottom"],
  ["flameAoe3dWakeSdfPerlinDensityTop", "wakeSdfPerlinDensityTop"],
...
export function createFlameAoe3dAuthoringAdapter({ flameAoe3dBehaviorDefault = {} } = {}) {
  ...
  function capture(els) {
    return Object.freeze({
      ...
      wakeSdfPerlinDensityBottom: fixedNumber(els && els.flameAoe3dWakeSdfPerlinDensityBottom && els.flameAoe3dWakeSdfPerlinDensityBottom.value, 2, FLAME_AOE_3D_DEFAULTS.wakeSdfPerlinDensityBottom),
      wakeSdfPerlinDensityTop: fixedNumber(els && els.flameAoe3dWakeSdfPerlinDensityTop && els.flameAoe3dWakeSdfPerlinDensityTop.value, 2, FLAME_AOE_3D_DEFAULTS.wakeSdfPerlinDensityTop),

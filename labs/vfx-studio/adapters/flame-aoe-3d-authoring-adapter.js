const FLAME_AOE_3D_FIELDS = Object.freeze([
  ...
  ["flameAoe3dWakeCloudsAmountBo", "wakeCloudsAmountBo"],
  ["flameAoe3dWakeCloudsMidlevel", "wakeCloudsMidlevel"],
  ["flameAoe3dWakeCloudsScale", "wakeCloudsScale"],
  ["flameAoe3dWakeCloudsSpeed", "wakeCloudsSpeed"],
  ["flameAoe3dWakeCloudsDetail", "wakeCloudsDetail"],
  ["flameAoe3dWakeCloudsSoftness", "wakeCloudsSoftness"],
...
export function createFlameAoe3dAuthoringAdapter() {
  ...
  function capture(els) {
    return Object.freeze({
      ...
      wakeCloudsAmountBo: fixedNumber(els && els.flameAoe3dWakeCloudsAmountBo && els.flameAoe3dWakeCloudsAmountBo.value, 3, FLAME_AOE_3D_DEFAULTS.wakeCloudsAmountBo),
      wakeCloudsMidlevel: fixedNumber(els && els.flameAoe3dWakeCloudsMidlevel && els.flameAoe3dWakeCloudsMidlevel.value, 2, FLAME_AOE_3D_DEFAULTS.wakeCloudsMidlevel),
      wakeCloudsScale: fixedNumber(els && els.flameAoe3dWakeCloudsScale && els.flameAoe3dWakeCloudsScale.value, 2, FLAME_AOE_3D_DEFAULTS.wakeCloudsScale),
      wakeCloudsSpeed: fixedNumber(els && els.flameAoe3dWakeCloudsSpeed && els.flameAoe3dWakeCloudsSpeed.value, 2, FLAME_AOE_3D_DEFAULTS.wakeCloudsSpeed),
      wakeCloudsDetail: Math.round(clampNumber(els && els.flameAoe3dWakeCloudsDetail && els.flameAoe3dWakeCloudsDetail.value, 1, 8, FLAME_AOE_3D_DEFAULTS.wakeCloudsDetail)),
      wakeCloudsSoftness: fixedNumber(els && els.flameAoe3dWakeCloudsSoftness && els.flameAoe3dWakeCloudsSoftness.value, 2, FLAME_AOE_3D_DEFAULTS.wakeCloudsSoftness),

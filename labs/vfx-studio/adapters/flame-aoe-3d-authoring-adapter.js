const FLAME_AOE_3D_FIELDS = Object.freeze([
  ...
  ["flameAoe3dWakeLagGraph0Pct", "wakeLagGraph0Pct"],
  ["flameAoe3dWakeLagGraph0Amount", "wakeLagGraph0Amount"],
  ["flameAoe3dWakeLagGraph1Pct", "wakeLagGraph1Pct"],
  ["flameAoe3dWakeLagGraph1Amount", "wakeLagGraph1Amount"],
  ["flameAoe3dWakeLagGraph2Pct", "wakeLagGraph2Pct"],
  ["flameAoe3dWakeLagGraph2Amount", "wakeLagGraph2Amount"],
  ["flameAoe3dWakeXDampGraph0Pct", "wakeXDampGraph0Pct"],
  ["flameAoe3dWakeXDampGraph0Damp", "wakeXDampGraph0Damp"],
  ["flameAoe3dWakeXDampGraph1Pct", "wakeXDampGraph1Pct"],
  ["flameAoe3dWakeXDampGraph1Damp", "wakeXDampGraph1Damp"],
  ["flameAoe3dWakeXDampGraph2Pct", "wakeXDampGraph2Pct"],
  ["flameAoe3dWakeXDampGraph2Damp", "wakeXDampGraph2Damp"],
  ["flameAoe3dWakeLeadingStrength", "wakeLeadingStrength"],
  ["flameAoe3dWakeLeadingWidth", "wakeLeadingWidth"],
...
export function createFlameAoe3dAuthoringAdapter() {
  ...
  function capture(els) {
    return Object.freeze({
      ...
      wakeLagGraph0Pct: optionalNumber(els && els.flameAoe3dWakeLagGraph0Pct && els.flameAoe3dWakeLagGraph0Pct.value, 0, 100),
      wakeLagGraph0Amount: optionalNumber(els && els.flameAoe3dWakeLagGraph0Amount && els.flameAoe3dWakeLagGraph0Amount.value, 0, 10),
      wakeLagGraph1Pct: optionalNumber(els && els.flameAoe3dWakeLagGraph1Pct && els.flameAoe3dWakeLagGraph1Pct.value, 0, 100),
      wakeLagGraph1Amount: optionalNumber(els && els.flameAoe3dWakeLagGraph1Amount && els.flameAoe3dWakeLagGraph1Amount.value, 0, 10),
      wakeLagGraph2Pct: optionalNumber(els && els.flameAoe3dWakeLagGraph2Pct && els.flameAoe3dWakeLagGraph2Pct.value, 0, 100),
      wakeLagGraph2Amount: optionalNumber(els && els.flameAoe3dWakeLagGraph2Amount && els.flameAoe3dWakeLagGraph2Amount.value, 0, 10),
      wakeXDampGraph0Pct: optionalNumber(els && els.flameAoe3dWakeXDampGraph0Pct && els.flameAoe3dWakeXDampGraph0Pct.value, 0, 100),
      wakeXDampGraph0Damp: optionalNumber(els && els.flameAoe3dWakeXDampGraph0Damp && els.flameAoe3dWakeXDampGraph0Damp.value, 0, 1),
      wakeXDampGraph1Pct: optionalNumber(els && els.flameAoe3dWakeXDampGraph1Pct && els.flameAoe3dWakeXDampGraph1Pct.value, 0, 100),
      wakeXDampGraph1Damp: optionalNumber(els && els.flameAoe3dWakeXDampGraph1Damp && els.flameAoe3dWakeXDampGraph1Damp.value, 0, 1),
      wakeXDampGraph2Pct: optionalNumber(els && els.flameAoe3dWakeXDampGraph2Pct && els.flameAoe3dWakeXDampGraph2Pct.value, 0, 100),
      wakeXDampGraph2Damp: optionalNumber(els && els.flameAoe3dWakeXDampGraph2Damp && els.flameAoe3dWakeXDampGraph2Damp.value, 0, 1),
      wakeLeadingStrength: fixedNumber(els && els.flameAoe3dWakeLeadingStrength && els.flameAoe3dWakeLeadingStrength.value, 2, FLAME_AOE_3D_DEFAULTS.wakeLeadingStrength),
      wakeLeadingWidth: fixedNumber(els && els.flameAoe3dWakeLeadingWidth && els.flameAoe3dWakeLeadingWidth.value, 2, FLAME_AOE_3D_DEFAULTS.wakeLeadingWidth),

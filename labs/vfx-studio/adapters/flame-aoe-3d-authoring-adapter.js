const FLAME_AOE_3D_FIELDS = Object.freeze([
  ...
  ["flameAoe3dWakeNoiseDensity", "wakeNoiseDensity"],
...
export function createFlameAoe3dAuthoringAdapter() {
  ...
  function capture(els) {
    return Object.freeze({
      ...
      wakeNoiseDensity: fixedNumber(els && els.flameAoe3dWakeNoiseDensity && els.flameAoe3dWakeNoiseDensity.value, 2, FLAME_AOE_3D_DEFAULTS.wakeNoiseDensity),

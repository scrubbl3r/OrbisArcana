const FLAME_AOE_3D_FIELDS = Object.freeze([
  ...
  ["flameAoe3dWakeDisplaceOctaves", "wakeDisplaceOctaves"],
...
export function createFlameAoe3dAuthoringAdapter() {
  ...
  function capture(els) {
    return Object.freeze({
      ...
      wakeDisplaceOctaves: Math.round(clampNumber(els && els.flameAoe3dWakeDisplaceOctaves && els.flameAoe3dWakeDisplaceOctaves.value, 1, 5, FLAME_AOE_3D_DEFAULTS.wakeDisplaceOctaves)),

const FLAME_AOE_3D_FIELDS = Object.freeze([
  ...
  ["flameAoe3dWakeSdfAlphaFadeStart", "wakeSdfAlphaFadeStart"],
  ["flameAoe3dWakeSdfAlphaFadeEnd", "wakeSdfAlphaFadeEnd"],
  ["flameAoe3dWakeSdfAlphaFadeCurve", "wakeSdfAlphaFadeCurve"],
  ...
  ["flameAoe3dWakeSdfNoiseBias", "wakeSdfNoiseBias"],
...
export function createFlameAoe3dAuthoringAdapter({ flameAoe3dBehaviorDefault = {} } = {}) {
  ...
  function capture(els) {
    return Object.freeze({
      ...
      wakeSdfAlphaFadeStart: fixedNumber(els && els.flameAoe3dWakeSdfAlphaFadeStart && els.flameAoe3dWakeSdfAlphaFadeStart.value, 2, FLAME_AOE_3D_DEFAULTS.wakeSdfAlphaFadeStart),
      wakeSdfAlphaFadeEnd: fixedNumber(els && els.flameAoe3dWakeSdfAlphaFadeEnd && els.flameAoe3dWakeSdfAlphaFadeEnd.value, 2, FLAME_AOE_3D_DEFAULTS.wakeSdfAlphaFadeEnd),
      wakeSdfAlphaFadeCurve: fixedNumber(els && els.flameAoe3dWakeSdfAlphaFadeCurve && els.flameAoe3dWakeSdfAlphaFadeCurve.value, 2, FLAME_AOE_3D_DEFAULTS.wakeSdfAlphaFadeCurve),
      ...
      wakeSdfNoiseBias: fixedNumber(els && els.flameAoe3dWakeSdfNoiseBias && els.flameAoe3dWakeSdfNoiseBias.value, 2, FLAME_AOE_3D_DEFAULTS.wakeSdfNoiseBias),
      wakeSdfRenderMode: Math.round(clampNumber(els && els.flameAoe3dWakeSdfRenderMode && els.flameAoe3dWakeSdfRenderMode.value, 0, 10, FLAME_AOE_3D_DEFAULTS.wakeSdfRenderMode)),

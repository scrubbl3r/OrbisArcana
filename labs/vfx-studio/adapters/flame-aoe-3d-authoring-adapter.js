const FLAME_AOE_3D_FIELDS = Object.freeze([
  ...
  ["flameAoe3dWakeSdfVelocityInherit", "wakeSdfVelocityInherit"],
  ["flameAoe3dWakeSdfMotionDrag", "wakeSdfMotionDrag"],
...
export function createFlameAoe3dAuthoringAdapter({ flameAoe3dBehaviorDefault = {} } = {}) {
  ...
  function capture(els) {
    return Object.freeze({
      ...
      wakeSdfVelocityInherit: fixedNumber(els && els.flameAoe3dWakeSdfVelocityInherit && els.flameAoe3dWakeSdfVelocityInherit.value, 2, FLAME_AOE_3D_DEFAULTS.wakeSdfVelocityInherit),
      wakeSdfMotionDrag: fixedNumber(els && els.flameAoe3dWakeSdfMotionDrag && els.flameAoe3dWakeSdfMotionDrag.value, 2, FLAME_AOE_3D_DEFAULTS.wakeSdfMotionDrag),

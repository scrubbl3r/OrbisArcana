...
export function createTesla1AuthoringAdapter({
  ...
  function capture(els = {}) {
    ...
    return Object.freeze({
      ...
      orbShellOverrideEnabled: els.tesla1OrbShellOverrideEnabled ? !!els.tesla1OrbShellOverrideEnabled.checked : tesla1PresetDefault.orbShellOverrideEnabled !== false,
      ...
      haloFieldBoltEndMinBo: readNumber(els.tesla1HaloFieldBoltEndMinBo, tesla1PresetDefault.haloFieldBoltEndMinBo, 0.01, 32),
      haloFieldBoltEndMaxBo: readNumber(els.tesla1HaloFieldBoltEndMaxBo, tesla1PresetDefault.haloFieldBoltEndMaxBo, 0.01, 32),
      haloBoltCountMin,
  ...
  function apply(els = {}, settings = null, options = {}) {
    ...
    if (els.tesla1OrbShellOverrideEnabled) els.tesla1OrbShellOverrideEnabled.checked = source.orbShellOverrideEnabled !== false;

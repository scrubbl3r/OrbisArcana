  ...
  switch (String(baseEffect || "")) {
    ...
    case "heal":
      return [
        ...
        `  shaderPulseSpotIntensityPct: ${Math.round(clampNum(p.healShaderSpotIntensityPct, 0, 300, 25))},`,
        `  shaderPulseSpotDistancePct: ${Math.round(clampNum(p.healShaderSpotDistancePct, 0, 300, 10))},`,

  ...
  switch (String(baseEffect || "")) {
    ...
    case "electric-aoe-3d": {
      ...
      const keys = [
        ...
        "haloBoltSegmentsMin", "haloBoltSegmentsMax", "haloBoltStepVariance", "haloBoltSeek",
        "haloBoltHeadingMemory", "haloBoltTurnAngleMin", "haloBoltTurnAngleMax", "haloBoltSmoothing", "haloBoltTension",

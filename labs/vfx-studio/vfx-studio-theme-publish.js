  ...
  switch (String(baseEffect || "")) {
    ...
    case "orb-lifecycle-3d": {
      ...
      return [
        ...
        `  spotIntensityMinPct: ${Math.round(clampNum(p.orbLifecycle3dSpotIntensityMinPct, 0, 300, 100))},`,
        `  spotIntensityMaxPct: ${Math.round(clampNum(p.orbLifecycle3dSpotIntensityMaxPct, 0, 300, 121))},`,
        `  spotDistanceMinPct: ${Math.round(clampNum(p.orbLifecycle3dSpotDistanceMinPct, 0, 300, 93))},`,
        `  spotDistanceMaxPct: ${Math.round(clampNum(p.orbLifecycle3dSpotDistanceMaxPct, 0, 300, 109))},`,
        ...
        `  healLuminanceBoostPct: ${Math.round(clampNum(p.orbLifecycle3dHealLuminanceBoostPct, 0, 300, 40))},`,
        `  healCenterAlphaPct: ${Math.round(clampNum(p.orbLifecycle3dHealCenterAlphaPct, 0, 300, 0))},`,
        `  healSpotIntensityPct: ${Math.round(clampNum(p.orbLifecycle3dHealSpotIntensityPct, 0, 300, 40))},`,
        `  healSpotDistancePct: ${Math.round(clampNum(p.orbLifecycle3dHealSpotDistancePct, 0, 300, 0))},`,
        `  healGoldMixPct: ${Math.round(clampNum(p.orbLifecycle3dHealGoldMixPct, 0, 300, 40))},`,
        `  healDurationMs: ${Math.round(clampNum(p.orbLifecycle3dHealDurationMs, 80, 10000, 2000))},`,
        `  healEasing: ${JSON.stringify(String(p.orbLifecycle3dHealEasing || "easeInOutQuad"))},`,
        "  crackColor: 0xffffff,",

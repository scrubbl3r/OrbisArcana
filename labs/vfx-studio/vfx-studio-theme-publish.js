  ...
  switch (String(baseEffect || "")) {
    ...
    case "orb-lifecycle-3d": {
      ...
      return [
        ...
        `  energyColor: ${colorHex("orbLifecycle3dEnergy", 0x94b8c2)},`,
        `  mutationSpeed: ${clampNum(p.orbLifecycle3dMutationSpeed, 0, 2, 0.12).toFixed(2)},`,
        `  mutationAmount: ${clampNum(p.orbLifecycle3dMutationAmount, 0, 1.5, 1).toFixed(2)},`,

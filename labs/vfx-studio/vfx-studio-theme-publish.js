  ...
  switch (String(baseEffect || "")) {
    ...
    case "tesla-1": {
      ...
      const keys = [
        ...
        "boltShaderEnabled", "boltShaderCoreWidthMinBo", "boltShaderCoreWidthMaxBo",
        "boltShaderGlowWidthMinBo", "boltShaderGlowWidthMaxBo", "boltShaderLengthTaper",
        "boltShaderTipOpacity", "boltShaderCoreIntensity", "boltShaderCoreSoftness",
        "boltShaderGlowIntensity", "boltShaderGlowSoftness", "boltShaderFlickerSpeedHz", "boltShaderFlickerDepth",
        "boltShaderCoreR", "boltShaderCoreG", "boltShaderCoreB", "boltShaderCoreA",
        "boltShaderGlowR", "boltShaderGlowG", "boltShaderGlowB", "boltShaderGlowA",
        "boltShaderCentralCoreEnabled", "boltShaderCentralCoreRadiusBo", "boltShaderCentralCoreGlowRadiusBo",
        "boltShaderCentralCoreNoiseScale", "boltShaderCentralCoreNoiseSpeed",
        "boltShaderCentralCoreIntensity", "boltShaderCentralCoreSoftness",

  ...
  switch (String(baseEffect || "")) {
    ...
    case "tesla-1": {
      ...
      const keys = [
        ...
        "orbLightFlashIntensityMultiplier", "orbLightMasterFlashMultiplier", "orbLightFlashDurationMinMs", "orbLightFlashDurationMaxMs", "orbLightFlashDecayCurve",
        "orbShellOverrideEnabled", "orbShellLuminanceBoost", "orbShellCenterAlpha", "orbShellGoldMix",
        "orbShellFieldBoltFlashAmount",
        ...
        "dominantBoltBaseWidthMultiplier",
        ...
        "boltShaderPlasmaCenterIntensity", "boltShaderPlasmaCenterRadiusBo",
        "boltShaderPlasmaBoltIntensity", "boltShaderPlasmaBoltRadiusBo",
        "boltShaderPlasmaCorePreserve",
        ...
        "haloBoltShapeWanderStrength", "haloBoltShapePathJitterBo", "haloBoltShapeSpeedHz", "haloBoltShapeSmoothing",
        "haloBoltForkChance", "haloBoltForkTtlMinMs", "haloBoltForkTtlMaxMs",
        "haloBoltForkStartPct", "haloBoltForkEndPct",
        "haloBoltForkSpreadMinBo", "haloBoltForkSpreadMaxBo", "haloBoltForkZTineMinBo", "haloBoltForkZTineMaxBo",
        "haloBoltForkTargetOffsetBo",
        "haloBoltBranchEnabled", "haloBoltBranchChance", "haloBoltBranchTotalMin", "haloBoltBranchTotalMax",
        "haloBoltBranchRangeStartPct", "haloBoltBranchRangeEndPct",
        "haloBoltBranchLengthMinBo", "haloBoltBranchLengthMaxBo",
        "haloBoltBranchAngleMinDeg", "haloBoltBranchAngleMaxDeg",
        "haloBoltBranchTtlMinMs", "haloBoltBranchTtlMaxMs",
        "haloBoltBranchStepMinBo", "haloBoltBranchStepMaxBo",
        "haloBoltBranchBendStrength", "haloBoltBranchCurlStrength", "haloBoltBranchShapeScale",
        ...
        "lightningShapeBranchAngleMinDeg", "lightningShapeBranchAngleMaxDeg",
        ...
        "wakeSdfEnabled", "wakeSdfParticleLifeMs", "wakeSdfSpawnRate", "wakeSdfSpawnAreaBo", "wakeSdfParticleRadiusBo",
        "wakeSdfLiftBias", "wakeSdfJitterBo", "wakeSdfHeatDecay", "wakeSdfDensity", "wakeSdfSoftnessBo",
        "wakeSdfAlphaFadeStart", "wakeSdfAlphaFadeEnd", "wakeSdfAlphaFadeCurve",
        ...
        "wakeSdfNoiseBlackPoint", "wakeSdfNoiseWhitePoint", "wakeSdfRenderMode",
        "wakeSdfDebugPoints",
...
export function buildFlameAoe3dBehaviorModule(params) {
  ...
  return [
    ...
    `  durationMs: ${Math.round(toNum(p.durationMs, 10000))},`,

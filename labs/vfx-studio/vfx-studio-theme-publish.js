  ...
  switch (String(baseEffect || "")) {
    ...
    case "electric-aoe-3d": {
      ...
      const keys = [
        ...
        "haloBoltForkLengthMaxBo", "haloBoltForkLengthMinBo", "haloBoltForksMax", "haloBoltForksMin",
        "haloBoltMaxRangeBo", "haloBoltMaxStepBo", "haloBoltMaxTotal", "haloBoltMaxWalkSpeed",
        "haloBoltMinRangeBo", "haloBoltMinStepBo", "haloBoltMinTotal", "haloBoltMinWalkSpeed", "haloBoltPathJitterBo",

...
export function createStudioBootstrap({
  ...
  const previewEls = Object.freeze({
    ...
    electricAoe3d: Object.freeze({
      ...
      electricAoe3dHaloFieldDirectionHoldMinMs: els.electricAoe3dHaloFieldDirectionHoldMinMs,
      electricAoe3dHaloFieldDirectionHoldMaxMs: els.electricAoe3dHaloFieldDirectionHoldMaxMs,

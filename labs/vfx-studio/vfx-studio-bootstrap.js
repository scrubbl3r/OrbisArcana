import { createStudioPreviewRegistry } from "./vfx-studio-preview-registry.js?v=20260523-tesla-b";
...
export function createStudioBootstrap({
  ...
  const previewEls = Object.freeze({
    ...
    tesla1: Object.freeze({
      ...
      electricAoe3dHaloFieldPointCount: els.tesla1LightningTreeBoltCountMax,
      ...
      electricAoe3dHaloBoltForkChance: els.tesla1LightningTreeForkChance,

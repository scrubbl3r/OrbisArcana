...
function readHealConfig(els = {}) {
  return Object.freeze({
    ...
    shaderPulsePointLightIntensityPct: Math.max(0, Math.round(readNumber(els.healShaderPointLightIntensityPct, 25))),
    shaderPulsePointLightDistancePct: Math.max(0, Math.round(readNumber(els.healShaderPointLightDistancePct, 10))),

...
export function createBubbleShield3dPreview({
  ...
  function readConfig() {
    return {
      ...
      mutationSpeed: clampNumber(els.shield3dMutationSpeed && els.shield3dMutationSpeed.value, 0, 2, 2),
      mutationAmount: clampNumber(els.shield3dMutationAmount && els.shield3dMutationAmount.value, 0, 1.5, 1.5),

declare const initXpu: (memory: WebAssembly.Memory, wasm: string | Promise<Response>) => {
    pv_xpu_webgpu_device_init_wasm: (objAddress: number, statusAddress: number) => Promise<void>;
    pv_xpu_webgpu_device_load_shader_wasm: (objAddress: number, libNameAddress: number, shaderNameAddress: number, statusAddress: number) => void;

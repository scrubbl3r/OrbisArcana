export const STARS_FIELD_CONFIG = Object.freeze({
  ...
  overscanDensityRatio: 0.22,
  jitterRatio: 0.42,
  maxJitterW: 54,
  seedSalt: "stars-field-v1",
  densityField: Object.freeze({
    lowFrequencyScaleW: 960,
    midFrequencyScaleW: 420,
    warpScaleW: 1280,
    warpAmplitudeW: 180,
    lowFrequencyWeight: 0.62,
    midFrequencyWeight: 0.38,
    contrast: 1.55,
    floor: 0.08,
    ceiling: 1.0,
  }),
  clusterField: Object.freeze({
    largeScaleW: 1680,
    smallScaleW: 760,
    largeWeight: 0.68,
    smallWeight: 0.32,

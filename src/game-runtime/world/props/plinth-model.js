...
export function getPlinthMetrics({ bo = 72 } = {}) {
...
export function createPlinthModel({
  bo = 72,
  material,
  decorateMesh = null,
} = {}) {
  const metrics = getPlinthMetrics({ bo });
...
export const getOrbSpawnPlinthMetrics = getPlinthMetrics;
export const createOrbSpawnPlinthModel = createPlinthModel;

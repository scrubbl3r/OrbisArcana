...
export function resolveOrbLifecycle3dConfig(config = ORB_LIFECYCLE_3D_DEFAULTS) {
  ...
  return Object.freeze({
    ...
    pointLightIntensityMinPct: clampNumber(source.pointLightIntensityMinPct, 0, 300, ORB_LIFECYCLE_3D_DEFAULTS.pointLightIntensityMinPct),
    pointLightIntensityMaxPct: clampNumber(source.pointLightIntensityMaxPct, 0, 300, ORB_LIFECYCLE_3D_DEFAULTS.pointLightIntensityMaxPct),
    pointLightDistanceMinPct: clampNumber(source.pointLightDistanceMinPct, 0, 300, ORB_LIFECYCLE_3D_DEFAULTS.pointLightDistanceMinPct),
    pointLightDistanceMaxPct: clampNumber(source.pointLightDistanceMaxPct, 0, 300, ORB_LIFECYCLE_3D_DEFAULTS.pointLightDistanceMaxPct),

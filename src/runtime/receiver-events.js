const EVT_VOICE_KWS_WORD_CANDIDATE = "voice.kws_spell_candidate";
const EVT_VOICE_KWS_SPELL_CANDIDATE = EVT_VOICE_KWS_WORD_CANDIDATE;
...
export const RECEIVER_EVENTS = Object.freeze({
  ...
  EVT_SPELL_WINDOW_SPIN_OPENED: "spell_window.spin_opened",
  EVT_SPELL_WINDOW_SPIN_CLOSED: "spell_window.spin_closed",
  EVT_SPELL_WINDOW_FLAT_SPIN_OPENED: "spell_window.spin_opened",
  EVT_SPELL_WINDOW_FLAT_SPIN_CLOSED: "spell_window.spin_closed",

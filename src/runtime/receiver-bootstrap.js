...
export async function loadReceiverInitModules() {
  const [
    ...
    Promise.all([
      import(`../vfx/presets/bubble-shield-default.js?v=${Date.now()}`),
      import(`../vfx/presets/bubble-shield-3d-default.js?v=${Date.now()}`),
      import(`../vfx/presets/shockwave-default.js?v=${Date.now()}`),
      import(`../vfx/presets/flame-aoe-default.js?v=${Date.now()}`),
      import(`../vfx/presets/electric-aoe-default.js?v=${Date.now()}`),
      import(`../vfx/presets/teleport-default.js?v=${Date.now()}`),
      import(`../vfx/presets/orb-nod-default.js?v=${Date.now()}`),
      import(`../vfx/presets/orb-nod3d-default.js?v=${Date.now()}`),
      import(`../vfx/presets/orb-spawn-default.js?v=${Date.now()}`),
      import(`../vfx/presets/hydrate-receiver-vfx-defaults.js?v=${Date.now()}`),
    ]).then(([
      bubbleShield,
      bubbleShield3d,
      shockwave,

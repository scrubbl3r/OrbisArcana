...
const RECEIVER_BOOTSTRAP_MODULE_CACHE_BUST_V = "20260525graviton";
...
export async function loadReceiverInitModules() {
  const [
    ...
    { BUBBLE_SHIELD_PRESET_DEFAULT, BUBBLE_SHIELD_3D_PRESET_DEFAULT, SHOCKWAVE_PRESET_DEFAULT, SHOCKWAVE_3D_PRESET_DEFAULT, FLAME_AOE_PRESET_DEFAULT, FLAME_AOE_3D_PRESET_DEFAULT, ELECTRIC_AOE_PRESET_DEFAULT, TESLA_1_PRESET_DEFAULT, TELEPORT_PRESET_DEFAULT, ORB_NOD_PRESET_DEFAULT, ORB_NOD_3D_PRESET_DEFAULT, ORB_SPAWN_PRESET_DEFAULT, hydrateReceiverVfxDefaults },
    ...
    import(`../runtime-effects/tesla-1-action.js?v=${RECEIVER_BOOTSTRAP_MODULE_CACHE_BUST_V}`),
    ...
    import("../vfx/presets/index.js?v=20260528152728i"),

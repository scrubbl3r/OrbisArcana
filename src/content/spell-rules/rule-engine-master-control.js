...
import { EVENT_DEFINITIONS } from "./event-definitions.js?v=20260519pyromodula";
import { EVENT_RUNTIME_BINDINGS_BY_ID } from "./event-runtime-bindings.js?v=20260519pyromodula";
import { SIGNAL_DEFINITIONS } from "./signal-definitions.js?v=20260519pyromodula";
import { WINDOW_DEFINITIONS } from "./window-definitions.js?v=20260519pyromodula";
...
const SIGNAL_MAX_ACTIONS_PER_EVENT_OVERRIDES = Object.freeze({
  // Example:
  // "spell.rota": 2,
});
...
const SIGNAL_EMIT_ACTION_EXECUTED_OVERRIDES = Object.freeze({
  // Example:
  // "spell.rota": false,
});

const SIGNAL_EMIT_SOURCE_EVENT_SUMMARY_OVERRIDES = Object.freeze({
  // Example:
  // "spell.rota": true,
});

const SIGNAL_SUMMARY_INCLUDE_SIGNAL_AND_RULE_IDS_OVERRIDES = Object.freeze({
  // Example:
  // "spell.rota": true,
});

const SIGNAL_SUMMARY_INCLUDE_BUDGET_CAPS_OVERRIDES = Object.freeze({
  // Example:
  // "spell.rota": true,
});

const SIGNAL_ACTION_EXECUTED_EVENT_TYPE_ENABLED_OVERRIDES = Object.freeze({
  // Example:
  // "spell.rota": { wake_win: false, event: true },
});
...
const SIGNAL_MAX_SIGNALS_PER_EVENT_OVERRIDES = Object.freeze({
  // Example:
  // "spell.rota": 1,
});

const SIGNAL_MAX_SIGNALS_EVALUATED_PER_EVENT_OVERRIDES = Object.freeze({
  // Example:
  // "spell.rota": 2,
});
...
const RULE_EMIT_SOURCE_EVENT_SUMMARY_OVERRIDES = Object.freeze({
  // Example:
...
const RULE_SUMMARY_INCLUDE_BUDGET_CAPS_OVERRIDES = Object.freeze({
  // Example:
  // r_rota_yspin_charged: true,
});
...
export const RULE_ENGINE_MASTER_CONTROL = Object.freeze({
  ...
  execution: Object.freeze({
    ...
    emitSourceEventSummaryEvents: false,
    sourceEventSummaryIncludeSignalAndRuleIds: false,
    sourceEventSummaryIncludeBudgetCaps: false,
    executeActions: true,
    actionExecutedEventTypeEnabled: Object.freeze({
      wake_win: true,
      event: true,
    }),
  ...
  ruleSummaryIncludeBudgetCapsOverrides: RULE_SUMMARY_INCLUDE_BUDGET_CAPS_OVERRIDES,
  ...
  signalEmitSourceEventSummaryOverrides: SIGNAL_EMIT_SOURCE_EVENT_SUMMARY_OVERRIDES,
  signalSummaryIncludeSignalAndRuleIdsOverrides: SIGNAL_SUMMARY_INCLUDE_SIGNAL_AND_RULE_IDS_OVERRIDES,
  signalSummaryIncludeBudgetCapsOverrides: SIGNAL_SUMMARY_INCLUDE_BUDGET_CAPS_OVERRIDES,
  ...
  signalMaxSignalsPerEventOverrides: SIGNAL_MAX_SIGNALS_PER_EVENT_OVERRIDES,
  signalMaxSignalsEvaluatedPerEventOverrides: SIGNAL_MAX_SIGNALS_EVALUATED_PER_EVENT_OVERRIDES,

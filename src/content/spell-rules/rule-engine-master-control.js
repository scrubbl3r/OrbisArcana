...
import { EVENT_DEFINITIONS } from "./event-definitions.js?v=20260518a";
import { EVENT_RUNTIME_BINDINGS_BY_ID } from "./event-runtime-bindings.js?v=20260518a";
import { SIGNAL_DEFINITIONS } from "./signal-definitions.js?v=20260518a";
import { WINDOW_DEFINITIONS } from "./window-definitions.js?v=20260518a";

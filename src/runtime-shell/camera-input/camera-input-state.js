...
export function createInitialCameraInputState({
  ...
  return {
    ...
    debug: {
      ...
      detectorRawX01: 0.5,
      detectorCoreX01: 0.5,
      detectorOuterX01: 0.5,
      detectorEdgeX01: 0.5,
      detectorWeightedX01: 0.5,
      detectorComponentCount: 0,
      detectorComponentPixels: 0,
      detectorComponentWidthPx: 0,
      detectorComponentHeightPx: 0,
      detectorCoreWidthPx: 0,
      detectorComponentScore: 0,
      detectorPriorX01: 0.5,
      detectorPriorAgeMs: 0,
      detectorPriorDistance01: -1,
      detectorContinuityMultiplier: 1,
      detectorOutputX01: 0.5,
      detectorOutputCenterX01: 0.5,
      detectorOutputGain: 1,
      detectorResultReason: "",
      detectorLandmarkGroups: 0,
      detectorHandednessGroups: 0,
      detectorBestScore: 0,
      detectorBestLandmarks: 0,
      detectorBestIndex: -1,
      detectorPalmCameraX01: 0.5,
      detectorPalmScreenX01: 0.5,
      detectorDetectedHandedness: "",
      trackWidth: 0,
      trackHeight: 0,
      trackFrameRate: 0,
      preloadMs: 0,

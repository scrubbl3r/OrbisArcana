import { createStagingShellRuntime } from "./create-staging-shell-runtime.js?v=20260521-electric-field-d";
import { createShellBootStatusController } from "./shell-boot-status.js?v=20260408a";

globalThis.__orbisStagingShellEntryVersion = "20260521-electric-field-d";

import { createStagingShellRuntime } from "./create-staging-shell-runtime.js?v=20260522forkTtlRangeAs";
import { createShellBootStatusController } from "./shell-boot-status.js?v=20260408a";

globalThis.__orbisStagingShellEntryVersion = "20260522forkTtlRangeAs";

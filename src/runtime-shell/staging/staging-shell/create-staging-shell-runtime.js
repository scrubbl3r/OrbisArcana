...
import { renderOrbStage } from "../orb-stage/orb-stage.js?v=20260424k";
...
import { renderLevelStage } from "../level-stage/level-stage.js?v=20260424q";
...
import { loadAuthoredLevelScene } from "../load-authored-level-scene.js?v=20260424e";
import {
...
function bindShellStarsTrace(shellContext) {
  ...
  const levelStageController = levelStageView && levelStageView.controller ? levelStageView.controller : null;
  ...
  kwsPanelController.pushGeneralLogLine("general log cleared for stars traces");
  const traceGeneral = (line) => kwsPanelController.pushGeneralLogLine(String(line || "").trim());
  levelStageAdapter.setTraceLogger(traceGeneral);
  if (levelStageController && typeof levelStageController.hydrateScene === "function") {
    void levelStageController.hydrateScene();
  }
}

...
export async function loadStagingInitModules(moduleCacheBustV = "") {
  const [
    ...
    legacyDomVfxRuntimesBundleModule,
    orbBaseStateModule,
    ...
    import(withVersion("./bootstrap-staging-runtime-bundle.js", moduleCacheBustV)),
    ...
    import("../../vfx/effects/legacy-dom-vfx-runtimes-bundle.js"),

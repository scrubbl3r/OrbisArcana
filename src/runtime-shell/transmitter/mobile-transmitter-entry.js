...
import { createTransmitterPacketPublisher } from "./transmitter-packet-publisher.js?v=20260511a";
import { createTransmitterAudioRuntime } from "./transmitter-audio-runtime.js";
import { createTransmitterMotionCore } from "./transmitter-motion-core.js?v=20260511a";
...
function loadLegacyTransmitterRuntime() {
  ...
  script.src = "../../../mobile-transmitter.js?v=20260511a";
  script.defer = true;

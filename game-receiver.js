    ...
    // =========================================================================
    const SHAKE_COOLDOWN_MS = 1000; // Minimum time between shake lamp triggers (ms)
    ...
    const SD_RECENT_MS = 700; // Direction label must arrive within this window (ms) to flash lamp

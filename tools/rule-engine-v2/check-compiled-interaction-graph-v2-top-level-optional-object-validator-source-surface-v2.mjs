...
const CHECK_TAG = "compiled-interaction-graph-v2-top-level-optional-object-validator-source-surface:v2";
const VALIDATOR_REL = "src/content/interactions-v2/validate-compiled-interaction-graph-v2.js";
const PASS_MESSAGE = "compiled-interaction-graph-v2 validator source preserves top-level defaults/groups object-type validation when present";

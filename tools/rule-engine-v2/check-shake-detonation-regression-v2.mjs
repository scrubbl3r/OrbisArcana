...
const PASS_MESSAGE = "shake detonation works for fallback and grouped modes";

function runScenario({ wakeWindowToken, expectedWordId, shakeGroup = "" }) {
...
function main() {
  runScenario({ wakeWindowToken: CHECK_SPELL_IDS_V2.sanctum, expectedWordId: CHECK_SPELL_IDS_V2.sanctum, shakeGroup: CHECK_SHAKE_GROUPS_V2.fallback });
  runScenario({ wakeWindowToken: CHECK_SPELL_IDS_V2.rota, expectedWordId: CHECK_SPELL_IDS_V2.rota, shakeGroup: CHECK_SHAKE_GROUPS_V2.fallback });
  runScenario({ wakeWindowToken: CHECK_SPELL_IDS_V2.sanctum, expectedWordId: CHECK_SPELL_IDS_V2.sanctum, shakeGroup: CHECK_SHAKE_GROUPS_V2.ud });
  runScenario({ wakeWindowToken: CHECK_SPELL_IDS_V2.rota, expectedWordId: CHECK_SPELL_IDS_V2.rota, shakeGroup: CHECK_SHAKE_GROUPS_V2.fb });

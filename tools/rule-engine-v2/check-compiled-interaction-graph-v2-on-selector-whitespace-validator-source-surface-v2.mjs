...
const CHECK_TAG = "compiled-interaction-graph-v2-on-selector-whitespace-validator-source-surface:v2";
const VALIDATOR_REL = "src/content/interactions-v2/validate-compiled-interaction-graph-v2.js";
const PASS_MESSAGE = "compiled-interaction-graph-v2 validator source preserves on selector whitespace validation for word/spin/shake/orb_state/spell";

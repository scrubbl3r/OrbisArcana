...
// Verifies interactions schema docs use canonical wordbook terminology and canonical word conditions.
...
const PASS_MESSAGE = "interactions schema uses canonical wordbook terminology and canonical word conditions";

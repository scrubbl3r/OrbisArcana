...
const CHECK_TAG = "orchestrator-v2-open-spells-compat-whitespace-validator-source-surface:v2";
const VALIDATOR_REL = "src/content/interactions-v2/validate-orchestrator-v2.js";
const PASS_MESSAGE = "orchestrator-v2 validator source preserves open.spells compat whitespace validation when open.words is present";

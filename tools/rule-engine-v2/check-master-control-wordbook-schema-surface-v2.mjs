...
const PASS_MESSAGE = "master-control artifacts use canonical wordbook/words terminology";
...
if (Object.hasOwn(masterRoot, "spellbook")) {
  failCheck(CHECK_TAG, "master-control json must not include legacy spellbook section");
}
...
if (Object.hasOwn(authoringRoot, "spells")) {
  failCheck(CHECK_TAG, "master-control authoring json must not include legacy spells section");
}

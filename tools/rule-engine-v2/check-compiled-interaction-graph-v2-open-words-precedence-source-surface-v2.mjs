...
const CHECK_TAG = "compiled-interaction-graph-v2-open-words-precedence-source-surface:v2";
const PASS_MESSAGE = "compiled-interaction-graph-v2 compiler and validator source preserve canonical open.words precedence over open.spells alias";

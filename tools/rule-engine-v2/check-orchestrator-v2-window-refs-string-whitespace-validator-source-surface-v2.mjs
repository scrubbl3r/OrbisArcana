...
const CHECK_TAG = "orchestrator-v2-window-refs-string-whitespace-validator-source-surface:v2";
const VALIDATOR_REL = "src/content/interactions-v2/validate-orchestrator-v2.js";
const PASS_MESSAGE = "orchestrator-v2 validator source preserves window-ref whitespace validation for string form";

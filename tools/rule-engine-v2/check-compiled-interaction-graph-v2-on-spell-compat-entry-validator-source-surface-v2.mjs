...
const CHECK_TAG = "compiled-interaction-graph-v2-on-spell-compat-entry-validator-source-surface:v2";
const VALIDATOR_REL = "src/content/interactions-v2/validate-compiled-interaction-graph-v2.js";
const PASS_MESSAGE = "compiled-interaction-graph-v2 validator source preserves on.spell compat entry validation even when on.word is present";

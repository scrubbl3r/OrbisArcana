...
const CHECK_TAG = "compiled-interaction-graph-v2-on-spell-compat-compiler-source-surface:v2";
const COMPILER_REL = "src/content/interactions-v2/build-rule-engine-from-compiled-interaction-graph-v2.js";
const PASS_MESSAGE = "compiled-interaction-graph-v2 compiler source preserves on.word precedence with on.spell fallback to canonical word selectors";

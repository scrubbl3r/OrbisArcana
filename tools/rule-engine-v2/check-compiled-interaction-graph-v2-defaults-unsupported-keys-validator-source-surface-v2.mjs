...
const CHECK_TAG = "compiled-interaction-graph-v2-defaults-unsupported-keys-validator-source-surface:v2";
const VALIDATOR_REL = "src/content/interactions-v2/validate-compiled-interaction-graph-v2.js";
const PASS_MESSAGE = "compiled-interaction-graph-v2 validator source preserves defaults key filtering to open/rule/trigger";

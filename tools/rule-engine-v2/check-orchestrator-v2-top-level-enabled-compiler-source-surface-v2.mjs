...
const CHECK_TAG = "orchestrator-v2-top-level-enabled-compiler-source-surface:v2";
const BUILDER_REL = "src/content/interactions-v2/build-rule-engine-from-compiled-interaction-graph-v2.js";
const PASS_MESSAGE = "orchestrator-v2 builder source preserves top-level enabled mapping into compiled rule-engine payload";

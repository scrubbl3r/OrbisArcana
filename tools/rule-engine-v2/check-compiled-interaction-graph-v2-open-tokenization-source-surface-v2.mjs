...
const CHECK_TAG = "compiled-interaction-graph-v2-open-tokenization-source-surface:v2";
const BUILDER_REL = "src/content/interactions-v2/build-rule-engine-from-compiled-interaction-graph-v2.js";
const PASS_MESSAGE = "compiled-interaction-graph-v2 builder source preserves shared tokenized parsing for open.words/open.spells alias paths";

...
const CHECK_TAG = "orchestrator-v2-defaults-section-shape-validator-source-surface:v2";
const VALIDATOR_REL = "src/content/interactions-v2/validate-orchestrator-v2.js";
const PASS_MESSAGE = "orchestrator-v2 validator source preserves defaults open/rule/trigger object-shape validation";

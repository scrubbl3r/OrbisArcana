...
const CHECK_TAG = "interactions-wake-words-compat-contract:v2";
...
const COMPAT_OPTIONAL_PASS_MESSAGE = "interactions wake-word alias contract is compat-optional when interactions bootstrap is disabled";

...
const CHECK_TAG = "compiled-interaction-graph-v2-defaults-trigger-unknown-event-source-surface:v2";
const VALIDATOR_REL = "src/content/interactions-v2/validate-compiled-interaction-graph-v2.js";
const PASS_MESSAGE = "compiled-interaction-graph-v2 validator source preserves defaults.trigger unknown-event validation";
